...
# Plot the data
actual <- lin_data |>
  ggplot(aes(x=mean_school, y=mean_life, color="darkseagreen")) +
  geom_point() +
...
formatted_table |>
  ...
  column_spec(2, color = "cornsilk", background = "tan") |>
...
predicted <- lin_data |>
  ...
  ggplot(aes(x=mean_school, y=preds, color="darkseagreen")) +
  geom_point() +
...
tibble(sims = sim_r_sq) |>
  ggplot(aes(x=sims, color="darkseagreen")) +
